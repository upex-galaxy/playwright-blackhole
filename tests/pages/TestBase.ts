...
import { SwagBurguerMenuPage } from './SwagBurguerMenuPage';
...
const test = driver.extend<{
	...
	swagBurguerMenuPage: SwagBurguerMenuPage;
}>({
	...
	swagBurguerMenuPage: async ({ page }, use) => await use(new SwagBurguerMenuPage(page)),
});
